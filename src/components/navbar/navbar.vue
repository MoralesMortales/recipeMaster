<template>
  <div class="w-full flex justify-between" style="height: 9dvh; z-index: -1001;" id="navbar">
    ...
    <div class="">
      <q-layout view="hHh Lpr lFf" style="height: 91dvh; z-index: -1000;" container class="absolute shadow-2 rounded-borders">
    <q-drawer 
      v-model="drawer"
      side="right"
      :width="300"
