...
<h1>
        Recetas con {{ formattedFoods }}</h1>
</div>

 <div v-for="(food, index) in recipes" :key="index" class="transition-all hover:transition-all hover:scale-110 hover:cursor-pointer h-96 w-72 flex rounded-2xl flex-col" style="background-color: #D9D9D9;">
