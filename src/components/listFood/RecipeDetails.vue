    ...
    <div class="flex flex-col md:flex-row gap-6 mb-6">
      ...
      <div class="md:w-2/3">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-4">
          <div>
            <h4 class="font-semibold text-gray-700">Calorías totales:</h4>
            <p></p>
          </div>
          <div>
            <h4 class="font-semibold text-gray-700">Costo estimado:</h4>
            <p>${{ recipe.pricePerServing }}</p>
          </div>
          <div>
            <h4 class="font-semibold text-gray-700">Tiempo de preparación:</h4>
